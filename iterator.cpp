...
typename Stablo<Tip>::Iterator Stablo<Tip>::Iterator::pomjeriNaGrani(function<Cvor * (Cvor * )> funkcijaPomjeranja) {
    ...
    while (funkcijaPomjeranja(trenutni) != nullptr)
        trenutni = funkcijaPomjeranja(
                trenutni); // Prolazimo kroz lijevo/desno podstablo dok ne dođemo do najmanjeg/najvećeg elementa
...
Stablo<Tip>::Reverse_Iterator::pomjeriNaGrani(std::function<Cvor * (Cvor * )> funkcijaPomjeranja) {
    ...
    while (funkcijaPomjeranja(trenutni) != nullptr)
        trenutni = funkcijaPomjeranja(
                trenutni); // prolazimo kroz lijevo/desno podstablo dok ne dođemo do najmanjeg/najveceg elementa
